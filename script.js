...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const pathPrefix = (window.location.pathname.includes('/artists/') || window.location.pathname.includes('/articles/') ||window.location.pathname.includes('/releases/') || window.location.pathname.includes('/interviews/')) ? '../' : '';
